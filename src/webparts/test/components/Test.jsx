  ...
  render(){
    return (
      <div className="container">
        ...
        <Button id="zero" value="0" display="0" class="num row-7 col-1" click={this.numInput} />
        <Button id="decimal" value="." display="." class="num row-7 col-3" click={this.decInput} />
        <Button id="equals" value="=*" display="=*" class="oper row-7 col-1-2" click={this.calculate} />
